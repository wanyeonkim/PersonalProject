...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyDa9BxUoe4pt9F1n9_JIuvX39SfibBv6wM';
    try {
  ...
  Future<bool> tryAutoLogin() async {
    //find the token and see if the token is still valid in the server
    // or sometime it wont be successful
    final prefs = await SharedPreferences.getInstance();
